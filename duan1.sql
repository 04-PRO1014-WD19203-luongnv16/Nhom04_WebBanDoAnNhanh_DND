...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 25, 2024 lúc 10:21 AM
...
CREATE TABLE `bill` (
  ...
  `bill_status` varchar(50) DEFAULT 'Pending' COMMENT 'tình trạng hóa đơn',
  `payment_status` varchar(50) DEFAULT 'Not Paid' COMMENT 'tình trạng thanh toán',
...
CREATE TABLE `product` (
  ...
  `product_description` text DEFAULT NULL COMMENT 'Mô tả Sản phẩm',
  ...
  `product_stock` int(11) DEFAULT NULL COMMENT 'kho sản phẩm',
  `category_id` int(11) DEFAULT NULL COMMENT 'Thể loại ID category',
...
(11, 'admin@gmail.com', '1234', '0339232504', 'Hà Nội', 'Nguyễn Khắc Đạt', '760241.jpg', 0, 'Active');
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID sản phẩm', AUTO_INCREMENT=32;
