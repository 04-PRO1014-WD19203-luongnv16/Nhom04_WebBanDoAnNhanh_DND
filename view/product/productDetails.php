        ...
        <div class="row mb-16">
            ...
            echo '
                ...
                <div class="col-md-4 mt-4">
                    <div class="col-12">
                        <img src="' . $imgPath . $product_avatar_url . '" class="card-img img-fluid w-100" alt="Product Image">
                    </div>
                </div>
                <div class="col-md-8 mt-3 mb-4">
                    <h1 class="h4 font-bold">' . $product_name . '</h1>
                    <div class="text-danger h4 font-bold">' . $product_sale_price . ' đ</div>
