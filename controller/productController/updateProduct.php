            ...
            <div class="content">
                <form action="index.php?act=updatePro" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Mô tả sản phẩm" name="product_description"><?= $product_description ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="product_import_price" value="<?= $product_import_price ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Giá sale</label>
                        <input type="number" class="form-control" name="product_sale_price" value="<?= $product_sale_price ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Giá bán</label>
                        <input type="number" class="form-control" name="product_listed_price" value="<?= $product_listed_price ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="btn-pass">
                        ...
                        <a href="index.php?act=listProducts"><input type="button" value="Danh sách" class="btn btn-primary"></a>
                    </div>
                    <?php
